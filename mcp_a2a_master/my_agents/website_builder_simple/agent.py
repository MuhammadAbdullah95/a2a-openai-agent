...
class WebsiteBuilderSimple:
    ...
    def __init__(self):
        self.system_instruction = load_instructions_file("my_agents/website_builder_simple/instructions.txt")
        self.description = load_instructions_file("my_agents/website_builder_simple/description.txt")
