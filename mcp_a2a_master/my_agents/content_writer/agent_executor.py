...
from my_agents.content_writer.agent import ContentWriterAgent
...
class ContentWriterAgentExecutor(AgentExecutor):
    """
    Implements the AgentExecutor interface to integrate the
    content writer agent with the A2A framework.
    """
